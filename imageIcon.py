...
for char in data:
    ...
    if(char["faction"]!="silent hunter"):
        ...
        im.save("./image/"+local_filename+".png",optimize=True,quality=100)
    ...
    if(char["char_rarity"]!="3"):
        ...
        im = Image.open(requests.get(url, stream=True).raw)
        im=im.resize((400,400),Image.ANTIALIAS)
        im.save("./image/"+local_filename+"3.png",optimize=True,quality=100)
    ...
    im.save("./icon/"+local_filename+".png",optimize=True,quality=100)